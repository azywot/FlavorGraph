...
class MetaPathWalker(object):
    ...
    def generate_metapaths(self, args):
        ...
        ### NEW WINE METAPATHS ###
        if "WHW" in args.which_metapath:
            print("# Metapath WHW")
            metapath_list = ["wine", "ingredient+hub", "wine"]
            return_list.append(metapath_list)

        if "WHNHW" in args.which_metapath:
            print("# Metapath WHNHW")
            metapath_list = [
                "wine",
                "ingredient+hub",
                "ingredient+no_hub",
        ...
        if "CHWHC" in args.which_metapath:
            print("# Metapath CHWHC")
            metapath_list = [
                "compound",
                "ingredient+hub",
                "wine",
        ...
        if "NHWHN" in args.which_metapath:
            print("# Metapath NHWHN")
            metapath_list = [
                "ingredient+no_hub",
                "ingredient+hub",
                "wine",
        ...
        if "WHCHW" in args.which_metapath:
            print("# Metapath WHCHW")
            metapath_list = [
                "wine",
                "ingredient+hub",
                "compound",
